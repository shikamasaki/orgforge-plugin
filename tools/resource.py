...
def main(argv):
    ...
    q.add_argument("root"); q.add_argument("--objectives", required=True)
    q.add_argument("--basis")

    q = sub.add_parser("reclaim"); q.set_defaults(fn=cmd_reclaim)
    q.add_argument("root"); q.add_argument("--holder", required=True)
    ...
    q.add_argument("root"); q.add_argument("--now-tick", dest="now_tick", type=int)
